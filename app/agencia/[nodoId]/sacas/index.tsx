...
const styles = StyleSheet.create({
  ...
  summaryValue: { fontSize: 28, fontWeight: '900', color: COLORS.black },
  ...
  movTime: { fontSize: 12, color: COLORS.gray },
  movQtd: { fontSize: 20, fontWeight: '800', color: COLORS.black, marginBottom: 2 },
  movDetail: { fontSize: 13, color: COLORS.gray },
});
